...
hi level8c guifg=brown
hi level9c guifg=gray
hi level10c guifg=black
hi level11c guifg=darkmagenta
hi level12c guifg=Darkblue
hi level13c guifg=darkgreen
hi level14c guifg=darkcyan
hi level15c guifg=darkred
hi level16c guifg=red
