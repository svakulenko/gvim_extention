...
"eafgt old options g - make item gray !?, t - degoutant tearoff menu
"go == guioptions
set guioptions=         " reset options
set guioptions+=a       " Visual highlighted text is available for pasting in vim and other app.
...
"set formatoptions+=B  " When joining lines, don't insert a space between two multi-byte
